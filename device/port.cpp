...
void serialPort::stop()
{
	...
	{
	case WAIT_OBJECT_0:
		SEND_LOG(L"ERROR serialPort::stop  停止秤重  WAIT_OBJECT_0");
		break;
	case WAIT_TIMEOUT:
		SEND_LOG(L"ERROR serialPort::stop  停止秤重  WAIT_TIMEOUT");
		break;
	case WAIT_FAILED:
		SEND_LOG(L"ERROR serialPort::stop  停止秤重  WAIT_FAILED");
		break;
	default:
		break;
	}
