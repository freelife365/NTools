...
public:
	...
	virtual bool write(uint8_t *pdata, uint32_t datalen) = 0;
	virtual int read(uint8_t *pbuf, uint32_t buflen) = 0;
};
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
	...
	virtual bool write(uint8_t *pdata, uint32_t datalen);
	virtual int read(uint8_t *pbuf, uint32_t buflen);
...
public:
	...
	// 数据读取线程
	static unsigned int WINAPI threadReadData(LPVOID pParam);
//protected:
	void start();
	void stop();
public:
